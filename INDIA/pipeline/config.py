...
PATHS = {
    "input":            os.path.join(BASE_DIR, "InputData",    "Pincode_input.csv"),
    "pincode_mapping":  os.path.join(BASE_DIR, "true_source",  "Pincode_mapping.csv"),
    ...
    "lost_dir":         os.path.join(BASE_DIR, "OutputData",   "lost"),
    ...
    # State-level lookups (internet, smartphone, CPI, median age)
    "state_internet":  os.path.join(BASE_DIR, "true_source", "state_lookups", "state_internet_penetration.csv"),
    "state_smartphone": os.path.join(BASE_DIR, "true_source", "state_lookups", "state_smartphone_penetration.csv"),
    "state_cpi":       os.path.join(BASE_DIR, "true_source", "state_lookups", "state_cpi.csv"),
    "state_median_age": os.path.join(BASE_DIR, "true_source", "state_lookups", "state_median_age.csv"),
    # State/city lookups (income, digital payment, property price)
    "state_income":    os.path.join(BASE_DIR, "true_source", "state_lookups", "state_income_bucket.csv"),
    "state_digital":   os.path.join(BASE_DIR, "true_source", "state_lookups", "state_digital_payment_index.csv"),
    "city_property":   os.path.join(BASE_DIR, "true_source", "state_lookups", "city_property_price.csv"),
}
...
# ─────────────────────────────────────────────
# COASTAL STATES (for state-level is_coastal fallback)
# ─────────────────────────────────────────────
COASTAL_STATES = {
    "gujarat", "maharashtra", "goa", "karnataka", "kerala", "tamil nadu",
    "andhra pradesh", "odisha", "west bengal", "puducherry", "pondicherry",
    "lakshadweep", "andaman and nicobar islands", "andaman & nicobar",
